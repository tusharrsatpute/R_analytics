...
#----Read the dataset------
getwd()
setwd("C:/Users/FUSION/Documents/R/CSV")
Plan_Dataset <- read.csv("New folder/InsurancePlanSubscriptions-2017.csv")
View(Plan_Dataset)
df <- Plan_Dataset
View(df)
...
setwd("C:/Users/FUSION/Documents/R/CSV")
sm2 <- read.csv("New folder/InsurancePlanSubscriptions-2018.csv")
View(sm2)
